...
def main():
    ...
    experiment_name = "deterministic_shielded"
    ...
    plot_sb3_metric(log_file, ["info/sum_crashed_into_building", "info/sum_collision"], f"{log_directory}/{experiment_name}_violations.png", "Deterministic Shielded Violations")
    plot_sb3_metric(log_file, "rollout/ep_rew_mean",            f"{log_directory}/{experiment_name}_rewards.png", "Deterministic Shielded Rewards")
