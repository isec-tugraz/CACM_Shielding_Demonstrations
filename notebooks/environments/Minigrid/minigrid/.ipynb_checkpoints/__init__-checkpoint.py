...
def register_minigrid_envs():
    ...
    register(
        id="MiniGrid-WindyCity2-v0",
        entry_point="minigrid.envs:WindyCity2Env",
        kwargs={'probability_intended': 0.95, 'probability_turn_intended': 0.95, "per_step_penalty": 0.01},
    )
    register(
        id="MiniGrid-WindyCity2Det-v0",
        entry_point="minigrid.envs:WindyCity2Env",
        kwargs={'probability_intended': 0.95, 'probability_turn_intended': 0.95, 'two_player_winning_region_start': True},
    )
    #register(
    #    id="MiniGrid-WindyCity-Adv-v0",
    #    entry_point="minigrid.envs:WindyCityAdvEnv",
    #    kwargs={'probability_intended': 0.95, 'probability_turn_intended': 0.95},
    #)

    register(
        id="MiniGrid-WindyCity-Adv-v0",
        entry_point="minigrid.envs:WindyCitySmallAdv",
        kwargs={'probability_intended': 1.00, 'probability_turn_intended': 1.00, "per_step_penalty": 0.02},
    )
