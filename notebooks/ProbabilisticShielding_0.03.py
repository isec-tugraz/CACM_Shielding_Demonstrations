...
def main():
    ...
    # The value used for training is 1.0 - epsilon from the paper
    value_for_training = 0.97
    shielding = ShieldingConfig.Training

    experiment_name = "probabilistic_shielded_0.0"
    ...
    plot_sb3_metric(log_file, "info/sum_crashed_into_building", f"{log_directory}/{experiment_name}_violations.png", "Probabilistic e=0.03 Violations")
    plot_sb3_metric(log_file, "rollout/ep_rew_mean",            f"{log_directory}/{experiment_name}_rewards.png", "Probabilistic e=0.03 Rewards")
