...
def main():
    ...
    experiment_name = "probabilistic_shielded_0.05"
    ...
    plot_sb3_metric(log_file, "info/sum_crashed_into_building", f"{log_directory}/{experiment_name}_violations.png", "Probabilistic e=0.05 Violations")
    plot_sb3_metric(log_file, "rollout/ep_rew_mean",            f"{log_directory}/{experiment_name}_rewards.png", "Probabilistic e=0.05 Rewards")
