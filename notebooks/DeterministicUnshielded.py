...
def main():
    ...
    experiment_name = "deterministic_unshielded"
    ...
    plot_sb3_metric(log_file, ["info/sum_crashed_into_building", "info/sum_collision"], f"{log_directory}/{experiment_name}_violations.png", "Deterministic Unshielded Violations")
    plot_sb3_metric(log_file, "rollout/ep_rew_mean",            f"{log_directory}/{experiment_name}_rewards.png", "Deterministic Unshielded Rewards")
